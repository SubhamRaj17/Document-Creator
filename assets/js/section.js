...
$('#navMenu').append('<a href="section3.'+extDirect+'" class="item">Server Details</a>');
...
$('#navMenu').append('<a href="section8.'+extDirect+'" class="item">Integration Plan</a>');
...
var categoryContent = [
    ...
    { category: 'Integration Plan', title: 'Integration Plan Details', url: 'section8.'+extDirect },
